	...
	<div class="top-header-group">
		<div class="top-header">
			<div class="res_main_logo">
				<a href="index.html"><img src="<?= base_url() ?>/assets/customers/images/dark-logo-1.svg" alt=""></a>
			</div>
			<div class="main_logo" id="logo">
				<a href="index.html"><img src="<?= base_url() ?>/assets/customers/images/logo.svg" alt=""></a>
				<a href="index.html"><img class="logo-inverse" src="<?= base_url() ?>/assets/customers/images/dark-logo.svg" alt=""></a>
			</div>
			...
			<div class="header_right">
				<ul>
					...
					<li>
						<a href="<?= base_url('customer/wishlist')?>" class="option_links" title="Wishlist"><i class='uil uil-heart icon_wishlist'></i><span class="noti_count1" id="count">3</span></a>
					</li>	
					<li class="ui dropdown">
						<a href="#" class="opts_account">
							<img src="<?= base_url() ?>/assets/customers/images/avatar/img-5.jpg" alt="">
							<span class="user__name"><?= $_SESSION['firstname']; ?></span>
						...
						<div class="menu dropdown_account">
							...
							<a href="<?= base_url('customer/dashboard'); ?>" class="item channel_item"><i class="uil uil-apps icon__1"></i>Dashbaord</a>								
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse d-flex flex-column flex-lg-row flex-xl-row justify-content-lg-end bg-dark1 p-3 p-lg-0 mt1-5 mt-lg-0 mobileMenu" id="navbarSupportedContent">
					<ul class="navbar-nav main_nav align-self-stretch">
							<li class="nav-item"><a href="<?= base_url('customer/dashboard'); ?>" class="nav-link active" title="Home">Home</a></li>
							...
							<li class="nav-item"><a href="<?= base_url('business/view'); ?>" class="nav-link" title="Businesses">Businesses</a></li>
							<li class="nav-item">
								<div class="ui icon top left dropdown nav__menu">
									<a class="nav-link" title="Pages">Pages <i class="uil uil-angle-down"></i></a>
									<div class="menu dropdown_page">
										<a href="<?= base_url('customer/profile')?>" class="item channel_item page__links">Account</a>
										<a href="<?= base_url('orders/checkout')?>" class="item channel_item page__links">Checkout</a>
	    								<a href="<?= base_url('orders/placed')?>" class="item channel_item page__links">Orders Placed</a>										
