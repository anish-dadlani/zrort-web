		...
		<main>
			<div class="container-fluid">
				...
				<ol class="breadcrumb mb-30">
					...
					<li class="breadcrumb-item"><a href="<?php echo base_url(); ?>/Productsunits
					<li class="breadcrumb-item active">View Product Units</li>
				</ol>
				<div class="row">
										...
										<div class="form-group">
												...
												<div class="card card-editor">
													<div class="content-editor">
														<textarea class="text-control" placeholder="Enter Description" name="description" disabled><?php echo  $productsunits_view[0]['description']; ?></textarea>
													</div>
												</div>
										</div>
										<div class="form-group">
											...
											<select id="status" name="is_active" class="form-control" disabled>
												<option selected value="1" <?php if($productsunits_view[0]['is_active'] == 1 ){ echo 'selected="selected"'; } else  { echo ''; } ?>>Active</option>
												<option value="0" <?php if($productsunits_view[0]['is_active'] == 0 ){ echo 'selected="selected"'; } else  { echo ''; } ?>>Inactive</option>
											</select>
										</div>
