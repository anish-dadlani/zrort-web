		<main>
			<div class="container-fluid">
				...
				<div class="row justify-content-between">
					<div class="col-lg-12">
						<a href="<?php echo base_url(); ?>/Categories-Add" class="add-btn hover-btn">Add New</a>
					</div>
						...
						<div class="card card-static-2 mt-30 mb-30">
							...
							<div class="card-body-table">
								<div class="table-responsive">
									...
									<table id="categoriesList" class="table ucp-table table-hover table-striped footable table-vcenter tbl-listing" data-filter="#filter" data-filter-text-only="true">
										<thead>
											<tr>
												<th>S#</th>
												<th>Title</th>
										...
										<tbody id="tbody">
											<?php $startpoint=0; $i=$startpoint;  foreach ($categories as $row):  $i++;?>
											<tr>
												<td class="text-center" ><?php echo $i; ?> </td>
												<td class="" ><?php echo $row['name']; ?></td>
												<td class="" ><?php echo $row['shortname']; ?></td>
												<td class="" ><?php echo get_business_name($row['bussiness_id']); ?></td>
												<td class="" ><?php echo $row['tags']; ?></td>
												<td class="" ><?php if($row['is_active']==1){echo 'Active';}else{echo 'Inactive';}?></td>
												<td class="action-btns">
													<a href="<?php echo base_url(); ?>/Categories-View/<?php echo $row['pk_id']?>" class="view-shop-btn" title="View"><i class="fas fa-eye"></i></a>
													<a href="<?php echo base_url(); ?>/Categories-Edit/<?php echo $row['pk_id']?>" class="edit-btn" title="Edit"><i class="fas fa-edit"></i></a>
													<a href="<?php echo base_url(); ?>/Categories-Delete/<?php echo $row['pk_id']?>" onclick="return confirm('Are you sure?')"><i class="fa fa-trash  cst-theme-text"></i></a>
												</td>
											</tr>
											<?php endforeach; ?>
										</tbody>
